...
def recently_created_user_with_no_logins():
    return User(
        ...
        user_creation_time="2023-08-04T00:00:00+00:00",
        password_enabled="TRUE",
        password_last_used="no_information",
        password_last_changed="2023-08-04T00:00:00+00:00",
...
def disabled_user():
    return User(
        ...
        password_last_used="2023-08-04T00:00:00+00:00",
...
def inactive_user():
    return User(
        username="test",
        arn="arn:aws:iam::12345678912:user/test",
        user_creation_time="2023-06-01T00:00:00+00:00",
        password_enabled="TRUE",
        password_last_used="2023-06-02T00:00:00+00:00",
        password_last_changed="2023-06-01T00:00:00+00:00",
        password_next_rotation="N/A",
        mfa_active="TRUE",
        access_key_1_active="FALSE",
        access_key_1_last_rotated="N/A",
